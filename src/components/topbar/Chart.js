...
export default function Chart({ title, grid }) {
  ...
  useEffect(() => {
    axios
      .get("http://127.0.0.1:8000/api/admin/finds-governates", {
      ...
      .then((response) => {
        ...
        var x = [
          ...
          { Governate: "Beqaa", "Medications Found": governates["Beqaa"] },
          {
            ...
            "Medications Found": governates["Mount Lebanon"],
          },
          {
            Governate: "Nabatieh",
            "Medications Found": governates["Nabatieh"],
          },
          {
            Governate: "North Governate",
            "Medications Found": governates["North Governate"],
          },
          {
            Governate: "South Governate",
            "Medications Found": governates["South Governate"],
          },
        ];
